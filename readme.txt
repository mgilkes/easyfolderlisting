...
Installation:
This module is designed for Joomla 3.8+. To install go to the install/uninstall extensions page of Joomla Administrator and upload the package file. Then go to the Module Manager page and activate the module.
...
Link to new Tab/Window - If link to files is set to Yes, this option determines if the file is opened in a new Browser Tab/Window or not.
